...
/*------
(SELECT COUNT(*)+1 
FROM (SELECT DISTINCT (Score) FROM Scores) AS uniqeScores 
WHERE Score > sc.Score) AS rank 


How many DISTINCT Scores that are bigger then 'Score' 
-------*/
